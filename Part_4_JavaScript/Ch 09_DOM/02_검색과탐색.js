//~ document.getElementById()
    ...
    var el = document.getElementById('child2') // # 없이 작성해야한다.
    console.log(el);
...
//~ document.querySelector()
    ...
    var el = document.querySelector('.child:first-child')
    console.log(el);
...
//~ N.previousSibling / N.nextSibling
    ...
    console.log('el.previousSibling.parentElement: ', el.previousSibling.parentElement);
    console.log('el.nextSibling: ', el.nextSibling);


//~ N.previousElementSibling / E.nextElementSibling
    // 요소의 이전 형제 혹은 다음 형제 요소를 반환한다.

    var el = document.querySelector('.child');
    console.log('el.previousElementSibling: ', el.previousElementSibling);
...
//~ E.children
    ...
    console.log('Array.from(el.children): ', Array.from(el.children));
